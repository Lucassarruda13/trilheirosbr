    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">@lang('Crie uma conta para fazer Inscrição!')</p>
            </div>
            <div class="modal-footer">
                <a href="{{ route('user.login') }}" class="btn btn--base btn--sm me-2">
                    @lang('Entrar com Minha Conta')
                </a>
                <p>ou</p>
                <a href="{{ route('user.register') }}" class="btn btn--base btn--sm">
                    @lang('Criar Nova Conta')
                </a>
            </div>
        </div>
    </div>
