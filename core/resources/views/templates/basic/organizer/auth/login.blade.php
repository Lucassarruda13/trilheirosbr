                ...
                <div class="account-form-wrapper">
                    <div class="account-form">
                        <div class="account-form__content mb-4">
                            ...
                            <h6 class="account-form__title"> @lang('Organizer Login') </h6>

                        </div>

                        @include($activeTemplate . 'partials.social_login')

                        <form method="POST" action="{{ route('organizer.login') }}" class="verify-gcaptcha">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    <div class="d-flex flex-wrap justify-content-between">
                                        ...
                                        <a href="{{ route('organizer.password.request') }}"
                                ...
                                @if (gs('organizer_registration'))
                                    <div class="col-sm-12">
                                        <div class="have-account text-center">
                                            <p class="have-account__text">@lang("Não tem uma conta?") <a
                                                    href="{{ route('organizer.register') }}"
                                                    class="have-account__link text--base">@lang('CRIAR CONTA')</a></p>
                                        </div>
                                    </div>
                                @endif
