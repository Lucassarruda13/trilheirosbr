...
<li class="sidebar-submenu-list__item {{ menuActive('user.event.ticket.scanner') }}">
    <a href="{{ route('user.event.ticket.scanner') }}" class="sidebar-submenu-list__link">
        <span class="text">@lang('Ticket Scanner')</span>
    </a>
</li>
